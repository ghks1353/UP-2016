...
class CharacterOverlayGuideView:UIOverlayGuideView {
	...
	override func viewDidLoad() {
		...
		///// Image setup
		guideGameCenterImage.image = UIImage( named: ThemeManager.getAssetPresets(themeGroup: .Default, themeID: ThemeManager.legacyDefaultTheme) + "guide-characters-gamecenter.png" )
		guideAchievementsImage.image = UIImage( named: ThemeManager.getAssetPresets(themeGroup: .Default, themeID: ThemeManager.legacyDefaultTheme) + "guide-characters-achevements.png" )
		
		guideEXPImage.image = UIImage( named: ThemeManager.getAssetPresets(themeGroup: .Default, themeID: ThemeManager.legacyDefaultTheme) + "guide-characters-exp.png" )
		guideLevelImage.image = UIImage( named: ThemeManager.getAssetPresets(themeGroup: .Default, themeID: ThemeManager.legacyDefaultTheme) + "guide-characters-level.png" )
		
		guideCharacterImage.image = UIImage( named: ThemeManager.getAssetPresets(themeGroup: .Default, themeID: ThemeManager.legacyDefaultTheme) + "guide-characters-astro.png" )
